        ...
        await axios.get(baseUrl, {params: {username: this.state.form.username, password: md5(this.state.form.password)}})
            ...
            .then(response=>{
                ...
                if(response.length>0){
                    ...
                    /* user is set as loggedin  */
                    //axios.patch(baseUrl,params={""})
    ...
    render() {
        return (
            <div className="loginMainContainer">
                ...
                <div className="containerPrincipal">    {/*Refers to the css for the page style */}
                    <div className="containerSecundario">
                        <div className="form-group">
                            ...
                            />
                            <br />
                            <label className="lblContrasena">Contraseña: </label>
                            <br />
                            <input
                                type="password"
                                className="form-control"
                ...
                <div className="loginBottonContainer">
                    Inicia sesión para jugar nuestro juego o registrate gratis.
                </div>
            </div>
        );
    }
